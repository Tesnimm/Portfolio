    ...
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent leading-right">
                Hi,I'm Tesnim Strazimiri
            </h1>
            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            As a highly driven computer engineering professional, I continuously strive to stay 
            at the forefront of technological advancements through active engagement in workshops, 
            conferences, and self-directed learning. I apply my technical expertise to develop innovative 
            solutions and have gained practical experience through internships and personal projects. 
            These experiences have significantly strengthened my problem-solving skills and deepened my 
            understanding of real-world industry practices.
            </p>
